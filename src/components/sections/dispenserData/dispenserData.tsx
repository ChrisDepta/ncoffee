...
export default function DispenserData() {
  ...
  return (
    ...
    <p className='my-12 md:my-0 md:px-12 text-3xl md:text-5xl font-extrabold tracking-wider text-black'>Dystrybutory butlowe 19l</p>
    ...
    <p className='my-12 md:my-0 md:px-12 text-3xl md:text-5xl font-extrabold tracking-wider text-black'>Dystrybutory sieciowe</p>
    <div className='overflow-x-hidden gap-0 md:gap-8 flex flex-wrap justify-start items-start md:px-12'>
