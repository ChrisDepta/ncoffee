...
export default function machineLeft({id, title, subtitle, li1, li2, li3, price, picture, characteristic, waterContainer, groundsContainer, coffeeContainer, power, weight, width, height, depth}: Props) {
  return (
        <div key={id} className='w-3/5 flex items-end justify-around mt-24 text-nbaige text-xl'>
          ...
          <div className='basis-1/2 my-12'>
            ...
            <p className='text-right my-4'>{subtitle}</p>
            <p className='text-right text-3xl capitalize mt-5'>{characteristic}</p>
