  ...
  return (
    ...
    <div className=' overflow-x-hidden z-10 text-white px-36 py-24 flex flex-wrap items-start justify-around w-screen bg-black'>
      ...
      <div className='text-xl mt-8 sm:mt-0 sm:ml-2'>
        ...
        <ul className='mt-8 '>
          <li className='w-32 mt-6 flex justify-between'><Image src={fb} width={30} height={30} priority alt={'facebook'}/><Link href="https://www.facebook.com/ncoffeemakesyourday" target="_blank" className=' ml-4 hover:text-nlila hover:scale-110 transition' >Facebook</Link></li>
          <li className='w-32 mt-6 flex justify-between'><Image src={insta} width={30} height={30} priority alt={'instagram'}/><Link href="https://www.instagram.com/ncoffee.your.day/" target="_blank" className='ml-4 hover:text-nlila hover:scale-110 transition' >Instagram</Link></li>
        </ul>
      </div>
      <div className='text-xl hidden xl:block'>
        ...
        <ul className='mt-8 '>
          ...
          <li className='w-32 mt-6 flex justify-between'><Link href="https://oryginalnysok.pl/" className=' hover:text-nlila hover:scale-110 transition'>Soki</Link></li>
