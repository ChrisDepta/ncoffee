...
export default function Footer() {
  return (
    <div className=' px-36 py-24 flex items-start justify-around w-screen bg-black'>
      <div className='flex flex-col items-end'>
      <Image src={logo} width={120} height={100} className='m-6 mt-16' priority alt={'ncoffee makes your day'}/>
      </div>
      <div className='text-xl '>
        <p className='text-2xl text-nturkis font-bold tracking-widest'>Social</p>
        <ul className='mt-8 '>
      ...
      <div className='text-xl'>
        <p className='text-2xl text-nturkis font-bold tracking-widest'>Produkty</p>
        <ul className='mt-8 '>
      ...
      <div className='text-xl'>
        <p className='text-2xl text-nturkis font-bold tracking-widest'>Maszyny</p>
        <ul className='mt-8 '>
      ...
      <div className='text-xl'>
        <p className='text-2xl text-nturkis font-bold tracking-widest'>firma</p>
        <ul className='mt-8 '>
