...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className={`bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-white to-nbluehome h-dvh`}>
        <div className="homePageLogoVertical landscape:homePageLogoHorizontal h-screen w-screen flex items-center justify-center ">
          <main className='z-20 h-screen w-10/12 flex portrait:flex-col portrait:items-center portrait:justify-center md:items-end md:justify-around'>
            <Link href="water" className='xs:text-5xl md:text-7xl tracking-wider text-white font-black xs:m-16 md:m-24 hover:scale-125 transition'>
              woda
            </Link>
            <Link href="coffee" className='xs:text-5xl  md:text-7xl tracking-wider text-white font-black xs:m-16 md:m-24 hover:scale-125 transition'>
              kawa
            </Link>
          </main>
        </div>
